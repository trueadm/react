  ...
  return props.x === undefined
    ? <div id="ads_pe_container">
        ...
        <div
          ...
          <div className="_4u-c">
            {[
              <div className="_2wdc" key=".hoz7vrpu.0">
                <span>
                  <div size="medium" className="_585n _585o _2wdd">
                    ...
                    <div className="_585r _2i-a _50f4">
                      ...
                      <a
                        ...
                        rel={undefined}
                        onClick={() => {}}>
                        <span display="inline" className=" _50f7">
                          Ads Manager
                        </span>
                      </a>
                                ...
                                <div>
                                  {[
                                    <div key="campaign_group_name_section98010048849317">
                                      <div className="_40bc _12k2 _4-u2  _4-u8">
                                        ...
                                        <div className="_5dw9 _5dwa clearfix">
                                          <div
                                            ...
                                            <span className="_38my">
                                              {[
                                                <span key="1">
                                                  Campaign ID: 98010048849317
                                                </span>,
                                                <div key="2" className="_5lh9">
                                                  <div
                                                    data-hover="tooltip"
